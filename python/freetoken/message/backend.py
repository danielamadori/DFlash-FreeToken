...
class UserMsg(BaseBackendMsg):
    ...
    # Prefix-cache tenancy: who may reuse what this request caches, and from which token its
    # private part begins. None keeps the single shared tree the server has always had.
